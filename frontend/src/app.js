...
// (dark theme, matching the Django UI). Public posture: a health banner only — no incident counts
// (those aren't for public eyes) — plus the self-service report/check form. Health is
